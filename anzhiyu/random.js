var posts=["2023/09/07/centos7-9安装python3-8/","2022/05/07/first-blog/","2024/09/30/html基本样式/","2024/09/23/数学公式/","2024/09/26/软件工程复习(1)/","2024/09/27/软件工程复习(2)/","2024/09/28/软件工程复习(3)/"];function toRandomPost(){
